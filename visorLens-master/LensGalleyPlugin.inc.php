...
class LensGalleyPlugin extends GenericPlugin {
	...
	function articleCallback($hookName, $args) {
		...
		if ($galley && in_array($galley->getFileType(), array('application/xml', 'text/xml')) && in_array($galley->getLabel(), array('LENS'))) {
	...
	function articleDownloadCallback($hookName, $args) {
		...
		if ($galley && in_array($galley->getFileType(), array('application/xml', 'text/xml')) && $galley->getFileId() == $fileId && in_array($galley->getLabel(), array('LENS'))) {
